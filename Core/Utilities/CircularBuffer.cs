// Acquired from https://github.com/joaoportela/CircularBuffer-CSharp/tree/master
// under the unlicense license <https://unlicense.org/>.
...
namespace PolyArchitect.Core {
    ...
    namespace CircularBuffer {
        ...
        public class CircularBuffer<T> : IEnumerable<T> {
            ...
            /// <summary>
            /// Current start index (corresponds to the index of the Front value).
            /// </summary>
            public int Start { get { return _start; } }

            /// <summary>
            /// Current end index (corresponds to the index of the Back value).
            /// </summary>
